...
const Header = () => {
  ...
  const options = [
    ...
    { label: 'proten', value: '1' },
    { label: 'creatin', value: '2' },
    { label: 'vitamen', value: '3' },
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-[#fff] transition-all ease-in-out duration-300  ${
        stickyMenu && 'shadow'
      }`}
    >
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link href="/" className="flex-shrink-0">
              <Image src="/images/logo/logo1.png" alt="Logo" width={180} height={36} />
            </Link>
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <button
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 ease-in duration-200 hover:text-[#dfdf0c]"
                    >
                      <svg
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            <div className="hidden xl:flex items-center gap-3.5">
              ...
              <div>
                <span className="block text-2xs text-dark-4 uppercase">How Us</span>
                <p className="font-medium text-custom-sm text-dark">click here</p>
              </div>
            </div>
            ...
            {!isLoggedIn ? (
              ...
              <Link
                href="/dashboardadmin"
                className="flex items-center gap-2 text-purple font-semibold hover:text-purple-800 transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M5.121 17.804A9.001 9.001 0 0112 3a9.001 9.001 0 016.879 14.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"
                  />
                </svg>
                My Account
              </Link>
